...
X86QuantumGates::X86QuantumGates(size_t qubitSumNumber) :qbit2stat(qubitSumNumber)
{

}
QGateParam& X86QuantumGates::findgroup(size_t qn)
{
...
return:      quantum error
*****************************************************************************************************************/
bool X86QuantumGates::qubitMeasure(size_t qn)
{
...
QError  X86QuantumGates::iSWAP(size_t qn_0, size_t qn_1, double theta, bool isConjugate, double error_rate)
{
    if (randGenerator() > error_rate)
    {
...
QError  X86QuantumGates::iSWAP(size_t qn_0, size_t qn_1, Qnum & vControlBit, double theta, bool isConjugate, double error_rate)
{
    if (randGenerator() > error_rate)
    {
...
QError  X86QuantumGates::CR(size_t qn_0, size_t qn_1, double theta, bool isConjugate, double error_rate)
{
    if (randGenerator() > error_rate)
    {
...
QError  X86QuantumGates::CR(size_t qn_0, size_t qn_1, Qnum & vControlBit, double theta, bool isConjugate, double error_rate)
{
    if (randGenerator() > error_rate)
    {
