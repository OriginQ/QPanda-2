...
from pyqpanda.pyQPanda import QMachineType, convert_originir_str_to_qprog, convert_qasm_string_to_originir, destroy_quantum_machine, init_quantum_machine
from pyqpanda.pyQPanda import convert_qasm_to_qprog
import unittest

class Test_QASMToOriginIR(unittest.TestCase):
    qasm_str_list = []
    ...
    def test_qasm_to_originir(self,qasm_str):
        print("### qasm_str:",qasm_str)
        machine = init_quantum_machine(QMachineType.CPU)
        originir_str = convert_qasm_string_to_originir(qasm_str)
        print("originir_str:",originir_str)
...
if __name__=="__main__":
    ...
    TQL = Test_QASMToOriginIR()
    for qasm_str in TQL.qasm_str_list:
        TQL.test_qasm_to_originir(TQL.U2_qasm)
