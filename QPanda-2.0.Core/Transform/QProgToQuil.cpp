...
void QProgToQuil::gateToQuil(AbstractQGateNode *p_gate)
{
    if (nullptr == p_gate)
    {
        throw param_error_exception("p_gate is null", false);
    }
...
void QProgToQuil::nodeToQuil(QNode *p_node)
{
    ...
    case NodeType::WHILE_START_NODE:
        throw param_error_exception("Don't support QWhileProg or QIfProg", false);
        break;
    case NodeType::MEASURE_GATE:
    ...
    case NodeType::NODE_UNDEFINED:
        ...
        break;
    default:
        throw param_error_exception("pNode is error", false);
        break;
    }
...
void QProgToQuil::dealWithQuilGate(AbstractQGateNode *p_gate)
{
    if (nullptr == p_gate)
    {
        throw param_error_exception("pGate is null", false);
    }
    ...
    case GateType::CPHASE_GATE:
        ...
        if (nullptr == p_angle)
        {
            throw param_error_exception("dynamic_cast error", false);
        }
...
ostream & operator<<(ostream & out, const QProgToQuil & prog)
{
