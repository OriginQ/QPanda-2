...
public:
	...
	virtual QCircuit build_to_condition_circuit(QVec &used_qubits, const AbstractSearchData &mini_data) = 0;
...
public:
	...
	QCircuit build_to_condition_circuit(QVec &oracle_qubits, const AbstractSearchData &mini_data) override {
