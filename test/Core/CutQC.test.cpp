...
static bool test_CutQC_1()
{
    ...
    cout << "fidelity : " << fidelity(qvm->getAllocateQubitNum(), 10000, acutal_result, result) << endl;
...
static bool test_CutQC_2()
{
    ...
    cout << "fidelity : " << fidelity(qvm->getAllocateQubitNum(), 4096, acutal_result, result) << endl;
...
TEST(CutQC, test1)
{
	...
	try
	{
		//test_val = test_CutQC_1();
		//test_val = test_CutQC_5();
		test_val = test_CutQC_7();
		//test_val = test_CutQC_8();
	}
	...
	cout << "CutQC test over, press Enter to continue." << endl;
	getchar();
