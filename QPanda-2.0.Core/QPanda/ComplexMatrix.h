...
class ComplexMatrix
{
    typedef complex<precision_t> data_t;
public:
    ComplexMatrix()
    {
    ...
    friend ostream& operator<<(ostream& out, const ComplexMatrix<qubit_number, precision_t>& mat)
    {
...
//    const ComplexMatrix<1> X({ 0,1,1,0 });
//    const ComplexMatrix<1> X1 = ComplexMatrix<1>({ 1,-1i,-1i,1 })*SQRT_half;
//    const ComplexMatrix<1> X3 = ComplexMatrix<1>({ 1,1i,1i,1 })*SQRT_half;
//    const ComplexMatrix<1> Y({ 0,-1i,1i,0 });
//    const ComplexMatrix<1> Z({ 1,0,0,-1 });
//    const ComplexMatrix<1> T({ 1,0,0,SQRT_half - SQRT_half * -1i });
