...
class Test_circuit_draw(unittest.TestCase):
    ...
    def test_draw_text_without_gate_params(self):
        print("##################test_draw_text_without_gate_params")
        init_machine = InitQMachine()
        machine = init_machine.m_machine
        q = machine.qAlloc_many(6)
        c = machine.cAlloc_many(6)
        ...
        print(draw_qprog(prog, 'text',with_gate_params=False))
        print("#######################")

    def test_draw_text_with_gate_params(self):
        print("##################test_draw_text_with_gate_params")
        init_machine = InitQMachine()
        machine = init_machine.m_machine
        q = machine.qAlloc_many(6)
        c = machine.cAlloc_many(6)
        ...
        print(draw_qprog(prog, 'text',with_gate_params=True))
        print("#######################")

    def test_draw_latex_without_gate_params(self):
        print("##################test_draw_latex_without_gate_params")
        init_machine = InitQMachine()
        machine = init_machine.m_machine
        q = machine.qAlloc_many(6)
        c = machine.cAlloc_many(6)
        ...
        print(draw_qprog(prog, 'latex',with_gate_params=False))
        print("#######################")

    def test_draw_latex_with_gate_params(self):
        print("##################test_draw_latex_with_gate_params")
        init_machine = InitQMachine()
        machine = init_machine.m_machine
        q = machine.qAlloc_many(6)
        c = machine.cAlloc_many(6)
        ...
        print(draw_qprog(prog, 'latex',with_gate_params=True))
        print("#######################")

    def print_qprog(self):
        print("##################print_qprog")
        init_machine = InitQMachine()
        machine = init_machine.m_machine
        q = machine.qAlloc_many(6)
    ...
    def test_draw_pic_without_gate_params(self):
        print("##################test_draw_pic_without_gate_params")
        init_machine = InitQMachine()
        machine = init_machine.m_machine
        q = machine.qAlloc_many(6)
        c = machine.cAlloc_many(6)
        ...
        print(draw_qprog(prog, 'pic',with_gate_params=False,filename="without_gate_params.png"))
        print("#######################")

    def test_draw_pic_with_gate_params(self):
        print("##################test_draw_pic_without_gate_params")
        init_machine = InitQMachine()
        machine = init_machine.m_machine
        q = machine.qAlloc_many(6)
        ...
        print(draw_qprog(prog, 'pic',with_gate_params=True,filename="with_gate_params.png"))
        print("#######################")
