...
#include "originirParserVisitor.h"


/**
 * This class provides an empty implementation of originirParserVisitor, which can be
 * extended to create a visitor which only needs to handle a subset of the available methods.
 */
class  originirParserBaseVisitor : public originirParserVisitor {
public:
  ...
  virtual antlrcpp::Any visitSingle_gate_with_two_parameter_declaration(originirParser::Single_gate_with_two_parameter_declarationContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitSingle_gate_with_three_parameter_declaration(originirParser::Single_gate_with_three_parameter_declarationContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual antlrcpp::Any visitSingle_gate_with_two_parameter_type(originirParser::Single_gate_with_two_parameter_typeContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitSingle_gate_with_three_parameter_type(originirParser::Single_gate_with_three_parameter_typeContext *ctx) override {
    return visitChildren(ctx);
  }
