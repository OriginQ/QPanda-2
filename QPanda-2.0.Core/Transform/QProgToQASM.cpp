...
void QProgToQASM::qProgToQASM(AbstractQGateNode * pQGata)
{
    if (nullptr == pQGata)
    {
        throw param_error_exception("pQGata is null",false);
    }
    if (nullptr == pQGata->getQGate())
    {
        throw param_error_exception("pQGata->getQGate() is null",false);
    }
    ...
    case CU_GATE: 
        {
            ...
            {
                throw param_error_exception("gate_parameter is null",false);
            }
...
void QProgToQASM::qProgToQASM(QNode * pNode)
{
    ...
    case NodeType::WHILE_START_NODE:
        throw param_error_exception("Un Support QNode", false);
        break;
...
ostream & operator<<(ostream & out, const QProgToQASM &qasm_qprog)
{
