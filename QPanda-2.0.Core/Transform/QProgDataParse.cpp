...
bool QProgDataParse::parse(QProg &prog)
{
    ...
    {
        throw param_error_exception("qProg is not empty", false);
    }
...
void QProgDataParse::parseQGateDataNode(QProg &prog, const uint_t type_and_number, const uint_t qubits_data)
{
    ...
    if (!qubit0)
    {
        throw param_error_exception("qAlloc failure", false);
    }
    ...
    case QPROG_NODE_TYPE_CPHASE_GATE:
        ...
        break;
    default:
        throw param_error_exception("QGate type error", false);
        break;
    }
...
float QProgDataParse::getAngle(const pair<uint_t, DataNode> &data_node)
{
    ...
    {
        throw param_error_exception("parse DAT failure", false);
    }
...
void QProgDataParse::parseQMeasureDataNode(QProg &prog, uint_t qubits_data)
{
    ...
    if (!cbit)
    {
        throw param_error_exception("cAlloc failure", false);
    }
...
{    
    ...
    case NOT:
        ...
        break;
    default:
        throw param_error_exception("operate is error", false);
        break;
    }
...
void QProgDataParse::parseDataNode(QProg &prog, const uint_t tail_number)
{
    ...
    case QPROG_NODE_TYPE_CEXPR_OPERATOR:
        ...
        break;
    default:
        throw param_error_exception("usType is error", false);
        break;
    }
...
bool binaryQProgFileParse(QProg &prog, const string &filename)
{
