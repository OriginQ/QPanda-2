...
class Graph 
{
    ...
    public:
        ...
        // Return the degree entering the vertex \p i.
        uint32_t inDegree(uint32_t i) const;
        // Return the degree leaving the vertex \p i.
        uint32_t outDegree(uint32_t i) const; 
        // Return the number of vertices.
        uint32_t size() const;
    
        // Return the set of succesors of some vertex \p i.
        std::set<uint32_t>& succ(uint32_t i);
		const std::set<uint32_t>& c_succ(uint32_t i) const;
        // Return the set of predecessors of some vertex \p i.
        std::set<uint32_t>& pred(uint32_t i); 
        // Return the set of adjacent vertices of some vertex \p i.
...
protected:
	...
	// Constructor to be used by whoever inherits this class.
...
public:
	...
	// Insert the edge (i, j) with weight w(i, j) = \p w.
