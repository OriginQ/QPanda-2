...
public:
	static uRef Create(QPanda::ArchGraph::sRef ag,  bool optimization = false,uint32_t max_partial = (std::numeric_limits<uint32_t>::max)(),
...
private:
	...
	OptBMTQAllocator(QPanda::ArchGraph::sRef ag,bool optimization, uint32_t max_partial, uint32_t max_children);
...
QPanda::QProg OBMT_mapping(QPanda::QProg prog, QPanda::QuantumMachine *quantum_machine,
	QPanda::QVec &qv, bool optimization =false,
