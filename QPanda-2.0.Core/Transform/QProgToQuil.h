...
Classes for Travesing QProg and store QGates as string use Quil instruction set .
...
public:
    ...
    */
    ...
    Note:
        None
    */
    friend ostream & operator<<(ostream &out, const QProgToQuil &prog);
...
protected:
    ...
    */
    ...
    /*
    convert QGate data to string and store the string in m_instructs
    param:
...
private:
    map<int, string> m_gate_type_map;
    vector<string>  m_instructs;
};
