...
#include "QPanda/ComplexMatrix.h"
...
Return      :
******************************************************************/
void decomposeDoubleQGate(AbstractQGateNode * pNode,
    QNode * pParentNode,
...
Return      :
******************************************************************/
void decomposeMultipleControlQGate(AbstractQGateNode *pNode, QNode * pParentNode, TransformDecomposition * traversalAlgorithm)
{
    vector<Qubit*> vTargetQubit;
...
Return      :
******************************************************************/
void decomposeControlUnitarySingleQGate(AbstractQGateNode * pNode, QNode * pParentNode, TransformDecomposition * traversalAlgorithm)
{
...
extern QCircuit swapQGate(vector<int> ShortestWay, string MetadataQGate);
/******************************************************************
...
void TransformDecomposition::insertQCircuit(AbstractQGateNode * pGateNode, QCircuit & qCircuit, QNode * pParentNode)
{
    if ((nullptr == pParentNode) || (nullptr == pGateNode))
    {
        ...
        getssErrMsg(ssErrMsg, "param is nullptr");
...
void deleteUnitQnode(AbstractQGateNode * pNode, QNode * pParentNode, TransformDecomposition *)
{
...
QCircuit swapQGate(vector<int> ShortestWay, string MetadataQGate)
{
    auto qCircuit = CreateEmptyCircuit();
...
void TransformDecomposition::mergeSingleGate(QNode * pNode)
{
    ...
    {
        stringstream ssErrMsg;
        getssErrMsg(ssErrMsg, "pNode is null");
        throw param_error_exception(ssErrMsg.str(), false);
    }
...
void TransformDecomposition::cancelControlQubitVector(QNode * pNode)
{
    ...
    {
        stringstream ssErrMsg;
        getssErrMsg(ssErrMsg, "param error");
        throw param_error_exception(ssErrMsg.str(), false);
    }
    ...
    if (PROG_NODE == iNodeType)
    {
        ...
        {
            stringstream ssErrMsg;
            getssErrMsg(ssErrMsg, "Unkown error");
            throw QPandaException(ssErrMsg.str(), false);
        }
...
void TransformDecomposition::TraversalOptimizationMerge(QNode * pNode)
{
    ...
    {
        stringstream ssErrMsg;
        getssErrMsg(ssErrMsg, "this param is not QNode");
        throw param_error_exception(ssErrMsg.str(), false);
    }
    ...
    {
        stringstream ssErrMsg;
        getssErrMsg(ssErrMsg, "the param cannot be a QGate or Measure");
        throw param_error_exception(ssErrMsg.str(), false);
    }
