...
//typedef qcomplex_t<double> qcomplex_t_t;
//typedef vector<qcomplex_t_t> state_t;
...
public:
    ...
    *************************************************************************************************************/
    ...
    virtual QError pMeasure(Qnum& qnum, vector<pair<size_t, double>> &mResult, 
						int select_max=-1) = 0;

	virtual QError pMeasure(Qnum& qnum, vector<double> &mResult) = 0;
