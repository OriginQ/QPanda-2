...
extern const COMPLEX NAME##00;\
extern const COMPLEX NAME##01;\
extern const COMPLEX NAME##10;\
extern const COMPLEX NAME##11;
...
extern const COMPLEX NAME##00 = U00;\
extern const COMPLEX NAME##01 = U01;\
extern const COMPLEX NAME##10 = U10;\
extern const COMPLEX NAME##11 = U11;
...
//#define double_const_qubit_gate(GATE_NAME,qn_0,qn_1,isConjugate,error_rate) \
//double_gate<GATE_NAME##_Matrix>(qn_0,qn_1,error_rate)
...
public:
    ...
    template<const COMPLEX& U00, const COMPLEX& U01, const COMPLEX& U10, const COMPLEX& U11>
    QError single_gate(size_t qn, bool isConjugate, double error_rate)
    {
        ...
        {
            COMPLEX temp;
            C00 = COMPLEX(C00.real(), -C00.imag());
            C01 = COMPLEX(C01.real(), -C01.imag());
            C10 = COMPLEX(C10.real(), -C10.imag());
            C11 = COMPLEX(C11.real(), -C11.imag());
            temp = C01;;
            C01 = U10;
            C10 = temp;
        }
    ...
    QError single_angle_gate(size_t qn, double theta, bool isConjugate, double error_rate)
    {
        COMPLEX alpha;
        COMPLEX beta;
        COMPLEX U00(cos(theta / 2), -sin(theta / 2)*Nz);
        COMPLEX U01(-sin(theta / 2)*Ny, -sin(theta / 2)*Nx);
        COMPLEX U10(sin(theta / 2)*Ny, -sin(theta / 2)*Nx);
        COMPLEX U11(cos(theta / 2), sin(theta / 2)*Nz);
        if (isConjugate)
        {
            COMPLEX temp;
            U00 = COMPLEX(U00.real(), -U00.imag());
            U01 = COMPLEX(U01.real(), -U01.imag());
            U10 = COMPLEX(U10.real(), -U10.imag());
            U11 = COMPLEX(U11.real(), -U11.imag());
            temp = U01;
            U01 = U10;
            U10 = temp;
        }
    ...
    /*QError CZ(size_t qn_0, size_t qn_1, bool isConjugate, double)
    {
    Qnum qvtemp;
    qvtemp.push_back(qn_0);
    qvtemp.push_back(qn_1);
    ...
    QError iSWAP(size_t qn_0, size_t qn_1, Qnum& vControlBit, double theta, bool isConjugate, double);

    inline QError iSWAP(size_t qn_0, size_t qn_1, bool isConjugate, double error_rate)
    {
        iSWAP(qn_0, qn_1, PI / 2, isConjugate, error_rate);
        return qErrorNone;
    }
    inline QError iSWAP(size_t qn_0, size_t qn_1, Qnum& vControlBit, bool isConjugate, double error_rate)
    {
        iSWAP(qn_0, qn_1, vControlBit, PI / 2, isConjugate, error_rate);
        return qErrorNone;
    }
    inline QError SqiSWAP(size_t qn_0, size_t qn_1, bool isConjugate, double error_rate)
    {
        iSWAP(qn_0, qn_1, PI / 4, isConjugate, error_rate);
        return qErrorNone;
    }
    inline QError SqiSWAP(size_t qn_0, size_t qn_1, Qnum& vControlBit, bool isConjugate, double error_rate)
    {
        iSWAP(qn_0, qn_1, vControlBit, PI / 2, isConjugate, error_rate);
        return qErrorNone;
    }
    QError CR(size_t qn_0, size_t qn_1, double theta, bool isConjugate, double error_rate);
    QError CR(size_t qn_0,
        size_t qn_1,
        Qnum& vControlBit,
        double theta,
        bool isConjugate,
