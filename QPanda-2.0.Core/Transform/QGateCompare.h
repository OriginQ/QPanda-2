...
public:
    ...
    Note:
        None
    */
    static size_t countQGateNotSupport(AbstractQuantumProgram *p_prog, const vector<vector<string>> &instructions);
    ...
    Note:
        None
    */
    static size_t countQGateNotSupport(AbstractQGateNode *p_gata, const vector<vector<string>> &instructions);
    ...
    Note:
        None
    */
    static size_t countQGateNotSupport(AbstractControlFlowNode *p_controlflow, const vector<vector<string>> &instructions);
    ...
    Note:
        None
    */
    static size_t countQGateNotSupport(AbstractQuantumCircuit *p_circuit, const vector<vector<string>> &instructions);
...
protected:
    ...
    Note:
        None
    */
    static size_t countQGateNotSupport(QNode *p_node, const vector<vector<string>> &instructions);
    ...
    Note:
        None
    */
    static bool isItemExist(const string &item, const vector<vector<string>> &instructions);
private:
};
